    ...
    <!-- Header -->
        ...
        <form method="post" action="<?php echo htmlentities($_SERVER["PHP_SELF"]);?>">
            <div class="row gtr-uniform">
                ...
                <div class="col-12">
                    <textarea name="description" id="description" placeholder="Type the category description here..." rows="6"></textarea>
                </div>
                <!-- Break -->
                <div class="col-7 col-12-xsmall">
                    <ul class="actions">
                        <li><input type="submit" value="Add New Category" name="submit" class="primary" /></li>
